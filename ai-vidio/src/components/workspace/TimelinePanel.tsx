    ...
    <section className="flex h-[205px] flex-col rounded-xl border border-slate-200 bg-white p-2.5 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          <div className="border-l border-slate-200 pl-3 text-xs text-slate-700">
            <span>总时长:</span>
            <div className="mt-0.5 font-mono text-sm text-slate-950">00:30</div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-1.5 px-1">
        <div className="relative h-4">
          ...
          <div className="absolute left-[14%] top-1 size-3 rounded-full border-2 border-[#1554ff] bg-white" />
          {[40, 60, 80, 100].map((point) => (
